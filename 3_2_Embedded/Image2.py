...
class Image:
    ...
    #이미지를 흑백으로 변환한 뒤 Threshold 값을 기준으로 0 또는 1로 값을 정한다
        ...
        if self.contours:
            ...
            #
            #print(self.middleX - self.contourCenterX)
            #print(self.contourCenterX+20)
            #print("llrlllrllrlllrlrl")
            #
            ...
            #print(self.getContourExtent(self.MainContour))
            #print("wewewewwewewewewewe")
        #return [self.contourCenterX, self.middleY,self.middleX-self.contourCenterX,self.getContourExtent(self.MainContour)]
        return [self.middleX-self.contourCenterX,self.getContourExtent(self.MainContour)]
